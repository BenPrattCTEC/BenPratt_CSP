...
public class GameScene: SKScene, SKPhysicsContactDelegate
{
    ...
    func newGame() -> Void
    {
        ...
        let transisionType = SKTransition.flipHorizontal(withDuration: 0.5)
        view?.presentScene(newGameScene, transition: transisionType)
    }
    ...
    public func didBegin(_ contact: SKPhysicsContact) -> Void
    {
        ...
        if((firstBody.categoryBitMask & CollisionCategories.Player != 0) && (secondBody.categoryBitMask & CollisionCategories.InvaderBullet != 0)){
            print("Player and InvderBullet Contact")
        }
